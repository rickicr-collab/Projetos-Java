...
public class TelaCalc extends JFrame {
	...
	public TelaCalc() {
		...
		panCalc.setBorder(new BevelBorder(BevelBorder.LOWERED, null, null, null, null));
		panCalc.setBounds(12, 164, 261, 153);
		...
		txtrSuperCalculadora.setText("           Calculadora Avancada ");
